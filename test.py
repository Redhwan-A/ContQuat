# python3 test.py  --batch_size 64  --dataset AFLW2000  --data_dir /home/redhwan/2/data/AFLW2000  --filename_list /home/redhwan/2/data/AFLW2000/files.txt --snapshot pretrained/300_best.pth
# python3 test.py  --batch_size 64  --dataset BIWI  --data_dir /home/redhwan/2/data/biwi/faces_0  --filename_list /home/redhwan/2/HPE/FSA-Net/data/BIWI_noTrack.npz --snapshot pretrained/300_best.pth
# python3 test.py  --batch_size 64   --dataset CMU --data_dir  /home/redhwan/2/HPE/DirectMHP/exps/sixdrepnet/datasets/CMU/val/  --filename_list /home/redhwan/2/HPE/DirectMHP/exps/sixdrepnet/datasets/CMU/files_val.txt --snapshot pretrained/CMU_best.pth
import time
import math
import re
import sys
