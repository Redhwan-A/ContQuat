...
# python3 train.py --dataset AFLW2000 --data_dir ./data/AFLW2000 --filename_list ./data/AFLW2000/files.txt  --output_string AFLW2000   # fast
# python3 train.py --dataset Pose_300W_LP --data_dir ./data/300W_LP --filename_list ./data/300W_LP/files.txt  --output_string 300W_LP   #20hours
# python3 train.py --dataset BIWI --data_dir ./data/BIWI/BIWIS7030_train.npz --filename_list ./data/BIWI/BIWIS7030_train.npz  --output_string BIWIS7030
# python3 train.py   --dataset CMU --data_dir ./data/CMU/train/   --filename_list ./data/CMU/files_train.txt --output_string CMU
import time
import datetime
import math
import re
...
from losses_quat import  (quaternion_distance_loss, quaternion_angular_error_loss, lie_algebra_loss,
                          unit_quaternion_regularization_loss, quaternion_loss, quaternion_mse_loss,
